    ...
    <div class="container">
        ...
        <form action="{{ route('profile.update', $profile->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="telegram" id="telegram" class="form-control" value="{{ old('telegram', $profile->telegram) }}">
            </div>

            <div class="mb-3">
                <label for="github" class="form-label">GitHub</label>
                <input type="text" name="github" id="github" class="form-control" value="{{ old('github', $profile->github) }}">
            </div>
