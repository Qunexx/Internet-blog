    ...
    <div class="container">
        ...
        @if (auth()->check())
            ...
            @if ($profile)
                ...
                @if($posts->isEmpty())
                    <a href="{{route('post.create')}}"> You don't have any post's yet, but you can change it! Make your
                        first!(click on the link) </a>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('post.show', $post->id) }}" class="btn btn-primary">Read
                                            More</a>
                                    </div>
                                </div>
                            </div>
            ...
            @else
                <h2>You are for the first time here, please fill the fields of your profile to be open to the
                    community</h2>
                @if (session('success'))
                    <div class="alert alert-success">
                        {{ session('success') }}
